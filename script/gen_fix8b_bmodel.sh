...
bmnetu -model $in_name/bm_network_bmnetp_deploy_int8_unique_top.prototxt -weight $in_name/bm_network_bmnetp.int8umodel --outdir $out_name --v 4 2>&1 | tee umodel_$in_name.log
